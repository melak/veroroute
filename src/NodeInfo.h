...
public:
	...
	void		SetIsComplete(bool b)			{ m_bComplete = b; }
	void		SetNodeId(int i)				{ m_nodeId = i; }
	const bool& GetIsComplete() const			{ return m_bComplete; }
...
private:
	bool				m_bComplete;	// true ==> All component pins with the nodeId are connected
