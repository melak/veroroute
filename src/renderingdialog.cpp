...
, m_pMainWindow(nullptr)
{
	...
	VEROROUTE_FONT_SIZE(ui->groupBox_bright)
	VEROROUTE_FONT_SIZE(ui->label_14)
	VEROROUTE_FONT_SIZE(ui->label_15)
	VEROROUTE_FONT_SIZE(ui->label_16)
	VEROROUTE_FONT_SIZE(ui->label_17)
	VEROROUTE_FONT_SIZE(ui->label_18)
	VEROROUTE_FONT_SIZE(ui->label_19)
	VEROROUTE_FONT_SIZE(ui->antiAliasOff)
	VEROROUTE_FONT_SIZE(ui->antiAliasOn)
	VEROROUTE_FONT_SIZE(ui->spinBox_bright)
	VEROROUTE_FONT_SIZE(ui->shade)
	VEROROUTE_FONT_SIZE(ui->comptext)
	VEROROUTE_FONT_SIZE(ui->comppins)
	VEROROUTE_FONT_SIZE(ui->spinBox_height)
	VEROROUTE_FONT_SIZE(ui->spinBox_width)
	VEROROUTE_FONT_SIZE(ui->padWidth)
	VEROROUTE_FONT_SIZE(ui->trackWidth)
	VEROROUTE_FONT_SIZE(ui->tagWidth)
	VEROROUTE_FONT_SIZE(ui->holeWidth)
	VEROROUTE_FONT_SIZE(ui->gapWidth)
	VEROROUTE_FONT_SIZE(ui->maskWidth)
	VEROROUTE_FONT_SIZE(ui->silkWidth)
	VEROROUTE_FONT_SIZE(ui->edgeWidth)
	VEROROUTE_FONT_SIZE(ui->fillWidth)
	VEROROUTE_FONT_SIZE(ui->viapadWidth)
	VEROROUTE_FONT_SIZE(ui->viaholeWidth)
	VEROROUTE_FONT_SIZE(ui->Xthermals)
	VEROROUTE_FONT_SIZE(ui->closeTracks)
	VEROROUTE_FONT_SIZE(ui->label_brightness)
	VEROROUTE_FONT_SIZE(ui->label_height)
	VEROROUTE_FONT_SIZE(ui->label_width)
	VEROROUTE_FONT_SIZE(ui->label_comptext)
	VEROROUTE_FONT_SIZE(ui->label_comppins)
	VEROROUTE_FONT_SIZE(ui->label_pad)
	VEROROUTE_FONT_SIZE(ui->label_track)
	VEROROUTE_FONT_SIZE(ui->label_tag)
	VEROROUTE_FONT_SIZE(ui->label_hole)
	VEROROUTE_FONT_SIZE(ui->label_viapad)
	VEROROUTE_FONT_SIZE(ui->label_viahole)
	VEROROUTE_FONT_SIZE(ui->label_gap)
	VEROROUTE_FONT_SIZE(ui->label_mask)
	VEROROUTE_FONT_SIZE(ui->label_silk)
	VEROROUTE_FONT_SIZE(ui->label_edge)
	VEROROUTE_FONT_SIZE(ui->label_fill)
	VEROROUTE_FONT_SIZE(ui->label_info)
	VEROROUTE_FONT_SIZE(ui->label_info_2)
#endif
}
