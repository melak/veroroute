...
, m_pMainWindow(nullptr)
{
	...
	VEROROUTE_FONT_SIZE(ui->autoColor)
	VEROROUTE_FONT_SIZE(ui->autoRoute)
	VEROROUTE_FONT_SIZE(ui->brokenList)
	VEROROUTE_FONT_SIZE(ui->checkBoxColor)
	VEROROUTE_FONT_SIZE(ui->checkBoxLine)
	VEROROUTE_FONT_SIZE(ui->checkBoxMono)
	VEROROUTE_FONT_SIZE(ui->checkBoxName)
	VEROROUTE_FONT_SIZE(ui->checkBoxPCB)
	VEROROUTE_FONT_SIZE(ui->checkBoxValue)
	VEROROUTE_FONT_SIZE(ui->crop)
	VEROROUTE_FONT_SIZE(ui->custom)
	VEROROUTE_FONT_SIZE(ui->fast)
	VEROROUTE_FONT_SIZE(ui->fill)
	VEROROUTE_FONT_SIZE(ui->grow)
	VEROROUTE_FONT_SIZE(ui->grow_2)
	...
	VEROROUTE_FONT_SIZE(ui->label_4)
	VEROROUTE_FONT_SIZE(ui->label_fill)
	VEROROUTE_FONT_SIZE(ui->label_hole)
	VEROROUTE_FONT_SIZE(ui->label_label)
	VEROROUTE_FONT_SIZE(ui->label_length)
	VEROROUTE_FONT_SIZE(ui->label_margin)
	VEROROUTE_FONT_SIZE(ui->label_name)
	VEROROUTE_FONT_SIZE(ui->label_pad)
	VEROROUTE_FONT_SIZE(ui->label_rotate)
	VEROROUTE_FONT_SIZE(ui->label_saturation)
	VEROROUTE_FONT_SIZE(ui->label_type)
	VEROROUTE_FONT_SIZE(ui->label_value)
	VEROROUTE_FONT_SIZE(ui->label_width)
	VEROROUTE_FONT_SIZE(ui->margin)
	VEROROUTE_FONT_SIZE(ui->nameEdit)
	VEROROUTE_FONT_SIZE(ui->padWidth)
	VEROROUTE_FONT_SIZE(ui->paste)
	VEROROUTE_FONT_SIZE(ui->rotateCCW)
	VEROROUTE_FONT_SIZE(ui->rotateCW)
	VEROROUTE_FONT_SIZE(ui->saturation)
	VEROROUTE_FONT_SIZE(ui->setColor)
	VEROROUTE_FONT_SIZE(ui->shrink)
	VEROROUTE_FONT_SIZE(ui->shrink_2)
	...
	VEROROUTE_FONT_SIZE(ui->tidy)
	VEROROUTE_FONT_SIZE(ui->typeComboBox)
	VEROROUTE_FONT_SIZE(ui->valueEdit)
	VEROROUTE_FONT_SIZE(ui->wipe)
#endif
