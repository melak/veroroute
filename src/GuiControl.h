...
public:
	...
	virtual void Load(DataStream& inStream) override
	{
		...
		if ( inStream.GetVersion() >= VRT_VERSION_44 )
			inStream.Load(m_bShowSolder);		// Added in VRT_VERSION_44
		m_bWireShare = true;
	...
	virtual void Save(DataStream& outStream) override
	{
		...
		outStream.Save(m_bShowSolder);		// Added in VRT_VERSION_44
	...
	bool SetShowSolder(const bool& b)		{ const bool bChanged = m_bShowSolder		!= b; m_bShowSolder		= b; return bChanged; }
	...
	const bool&			GetShowSolder() const		{ return m_bShowSolder; }
...
private:
	...
	bool		m_bShowSolder		= true;				// true ==> show solder blobs in vero mode
