...
{
public:
	Shape(SHAPE type = SHAPE::RECT, double x1 = 0, double x2 = 0, double y1 = 0, double y2 = 0)
	: m_type(type)
	, m_x1(x1), m_x2(x2)
	, m_y1(y1), m_y2(y2)
	, m_a1(0), m_a2(90)
	...
	Shape(SHAPE type, double x1, double x2, double y1, double y2, double a1, double a2)
	: m_type(type)
	, m_x1(x1), m_x2(x2)
	, m_y1(y1), m_y2(y2)
	, m_a1(a1), m_a2(a2)
...
private:
	...
	double	m_a1, m_a2;	// Angles measured CCW degrees.  Zero at 3 o'clock.
};
