...
// parts on the grid, but we could probably no longer simply check against a single "SOIC_FULL" code.
// It all depends on whether multiple SOIC pads at a location can also share with a TH pin.
